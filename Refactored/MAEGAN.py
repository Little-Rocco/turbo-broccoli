...
#optimizer_discriminator = torch.optim.SGD(engine.discriminator.parameters(), lr=0.01, momentum=0.9)
optimizer_discriminator = torch.optim.Adam(engine.discriminator.parameters(), lr=engine.opt.lr,
                                           betas=(engine.opt.beta1, 0.999))
#optimizer_generator = torch.optim.SGD(engine.generator.parameters(), lr=0.01, momentum=0.9)
